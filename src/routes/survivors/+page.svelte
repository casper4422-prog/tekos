    ...
    <div class="featured-block">
        <div class="section-head">
            <div class="section-title-wrap">
                <div class="section-title">Notable Survivors</div>
            </div>
            <div class="section-meta">RANK · LEGEND OR HIGHER</div>
        </div>
        ...
        <div class="featured-grid">
            ...
            <a href="#" class="featured-card">
                <div class="featured-badge">◆ MYTH</div>
                <div class="featured-card-head">
                    <div class="feat-avatar">
                        <svg viewBox="0 0 52 58">
                            <defs><linearGradient id="avSp" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#fff8c0"/><stop offset="100%" stop-color="#ffd700"/></linearGradient></defs>
                            <polygon points="26,3 48,15 48,43 26,55 4,43 4,15" fill="rgba(10,18,44,0.85)" stroke="url(#avSp)" stroke-width="2"/>
                            <text x="26" y="36" font-family="Orbitron" font-size="20" font-weight="900" fill="url(#avSp)" text-anchor="middle">S</text>
                        </svg>
                    </div>
                    <div class="feat-info">
                        <div class="feat-name">Specter</div>
                        <div class="feat-rank"><span class="dot"></span>BREEDER · MYTH</div>
                    </div>
                </div>
                <div class="featured-bio">"3 Diamond bloodlines. I trade only when the price respects the line."</div>
                <div class="featured-stats-row">
                    <div class="feat-stat"><div class="feat-stat-val">219</div><div class="feat-stat-label">Specimens</div></div>
                    <div class="feat-stat"><div class="feat-stat-val gold">4.97★</div><div class="feat-stat-label">Trade Rep</div></div>
                    <div class="feat-stat"><div class="feat-stat-val diamond">3</div><div class="feat-stat-label">Diamond</div></div>
                    <div class="feat-stat"><div class="feat-stat-val">42</div><div class="feat-stat-label">Badges</div></div>
                </div>
            </a>

            <!-- Onyx -->
            <a href="#" class="featured-card">
                <div class="featured-badge">★ LEGEND</div>
                <div class="featured-card-head">
                    <div class="feat-avatar">
                        <svg viewBox="0 0 52 58">
                            <defs><linearGradient id="avOn" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#fda4af"/><stop offset="100%" stop-color="#ef4444"/></linearGradient></defs>
                            <polygon points="26,3 48,15 48,43 26,55 4,43 4,15" fill="rgba(10,18,44,0.85)" stroke="url(#avOn)" stroke-width="2"/>
                            <text x="26" y="36" font-family="Orbitron" font-size="20" font-weight="900" fill="url(#avOn)" text-anchor="middle">O</text>
                        </svg>
                    </div>
                    <div class="feat-info">
                        <div class="feat-name">Onyx_Alpha</div>
                        <div class="feat-rank"><span class="dot"></span>BOSS HUNTER · LEGEND</div>
                    </div>
                </div>
                <div class="featured-bio">"Titan Slayer × 4. If your fight needs a Carcharo line, mine's already there."</div>
                <div class="featured-stats-row">
                    <div class="feat-stat"><div class="feat-stat-val">87</div><div class="feat-stat-label">Specimens</div></div>
                    <div class="feat-stat"><div class="feat-stat-val gold">4.84★</div><div class="feat-stat-label">Trade Rep</div></div>
                    <div class="feat-stat"><div class="feat-stat-val">2</div><div class="feat-stat-label">Diamond</div></div>
                    <div class="feat-stat"><div class="feat-stat-val">38</div><div class="feat-stat-label">Badges</div></div>
                </div>
            </a>
            ...
            <a href="#" class="featured-card">
                ...
                <div class="featured-card-head">
                    <div class="feat-avatar">
                        <svg viewBox="0 0 52 58">
                            <defs><linearGradient id="avTw" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#c4a3f8"/><stop offset="100%" stop-color="#8b5cf6"/></linearGradient></defs>
                            <polygon points="26,3 48,15 48,43 26,55 4,43 4,15" fill="rgba(10,18,44,0.85)" stroke="url(#avTw)" stroke-width="2"/>
                            <text x="26" y="36" font-family="Orbitron" font-size="20" font-weight="900" fill="url(#avTw)" text-anchor="middle">T</text>
                        </svg>
                    </div>
                    <div class="feat-info">
                        <div class="feat-name">Twilight_Bred</div>
                        <div class="feat-rank">◌ OFFLINE · LEGEND</div>
                    </div>
                </div>
                <div class="featured-bio">"Therizino specialist. Helped 27 tribes hit their first Gold bloodline."</div>
                <div class="featured-stats-row">
                    <div class="feat-stat"><div class="feat-stat-val">156</div><div class="feat-stat-label">Specimens</div></div>
                    <div class="feat-stat"><div class="feat-stat-val gold">4.91★</div><div class="feat-stat-label">Trade Rep</div></div>
                    <div class="feat-stat"><div class="feat-stat-val diamond">1</div><div class="feat-stat-label">Diamond</div></div>
                    <div class="feat-stat"><div class="feat-stat-val">35</div><div class="feat-stat-label">Badges</div></div>
                </div>
            </a>
            ...
            <a href="#" class="featured-card">
                ...
                <div class="featured-card-head">
                    <div class="feat-avatar">
                        <svg viewBox="0 0 52 58">
                            <defs><linearGradient id="avEm" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#fbbf24"/><stop offset="100%" stop-color="#f59e0b"/></linearGradient></defs>
                            <polygon points="26,3 48,15 48,43 26,55 4,43 4,15" fill="rgba(10,18,44,0.85)" stroke="url(#avEm)" stroke-width="2"/>
                            <text x="26" y="36" font-family="Orbitron" font-size="20" font-weight="900" fill="url(#avEm)" text-anchor="middle">E</text>
                        </svg>
                    </div>
                    <div class="feat-info">
                        <div class="feat-name">Ember.Trades</div>
                        <div class="feat-rank"><span class="dot"></span>TRADER · LEGEND</div>
                    </div>
                </div>
                <div class="featured-bio">"Cluster broker. Loaded Crysis to The Confluence. Fair prices, escrow always."</div>
                <div class="featured-stats-row">
                    <div class="feat-stat"><div class="feat-stat-val">340</div><div class="feat-stat-label">Trades</div></div>
                    <div class="feat-stat"><div class="feat-stat-val gold">5.00★</div><div class="feat-stat-label">Trade Rep</div></div>
                    <div class="feat-stat"><div class="feat-stat-val">—</div><div class="feat-stat-label">Diamond</div></div>
                    <div class="feat-stat"><div class="feat-stat-val">21</div><div class="feat-stat-label">Badges</div></div>
                </div>
            </a>
