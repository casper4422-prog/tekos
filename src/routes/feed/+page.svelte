<script lang="ts">
    ...
    let activeTab = $state<'all' | 'following' | 'tribe' | 'server' | 'global'>('all');
...
<div class="stage">
    ...
    <div class="scope-tabs">
        <button class="scope-tab" class:active={activeTab === 'all'} onclick={() => activeTab = 'all'}>All</button>
        <button class="scope-tab" class:active={activeTab === 'following'} onclick={() => activeTab = 'following'}>Following</button>
        <button class="scope-tab" class:active={activeTab === 'tribe'} onclick={() => activeTab = 'tribe'}>Tribe</button>
        <button class="scope-tab" class:active={activeTab === 'server'} onclick={() => activeTab = 'server'}>Server</button>
        <button class="scope-tab" class:active={activeTab === 'global'} onclick={() => activeTab = 'global'}>Global</button>
    </div>

    <!-- ═══════════ ALL TAB — mixed feed from every source ═══════════ -->
    <div class="tab-content" class:active={activeTab === 'all'}>
        <div class="filter-row">
            <button class="chip active">All Sources</button>
            <button class="chip"><span class="glyph">⬡</span>Personal</button>
            <button class="chip"><span class="glyph">⌬</span>Tribe</button>
            <button class="chip"><span class="glyph">🌐</span>Server</button>
            <button class="chip"><span class="glyph">📡</span>News</button>
        </div>
        <div class="feed">
    ...
    <div class="tab-content" class:active={activeTab === 'following'}>
        <div class="filter-row">
            ...
            <button class="chip"><span class="glyph">🧬</span>Breeding</button>
            <button class="chip"><span class="glyph">⬢</span>Badges</button>
        </div>
        <div class="feed">
            <div class="feed-event breeding">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(0,180,255,0.18)" stroke="#00b4ff" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#7dd3fc">S</text></svg><span class="type-glyph">🧬</span></div>
                <div class="feed-body">
                    <div class="feed-text"><span class="who">Specter</span> bred <span class="what">Wyvern · Lightning "Storm Jr"</span> · STA mutation +1</div>
                    <div class="feed-meta"><span class="source">⬡ following</span><span class="sep">·</span>Lvl 414 · 42 muts</div>
                </div>
                <div class="feed-time">12m</div>
            </div>
            <div class="feed-event diamond">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(255,215,0,0.18)" stroke="#ffd700" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#fde047">D</text></svg><span class="type-glyph">⬢</span></div>
                <div class="feed-body">
                    <div class="feed-text"><span class="who">Drift</span> bred a <strong>60-mutation Wyvern</strong> · highest on server this week</div>
                    <div class="feed-meta"><span class="source">⬡ following</span><span class="sep">·</span>Lvl 448</div>
                </div>
                <div class="feed-time">6h</div>
            </div>
            <div class="feed-event badge">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(16,185,129,0.18)" stroke="#10b981" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="40" font-weight="900" text-anchor="middle" fill="#86efac">St</text></svg><span class="type-glyph">⬢</span></div>
                <div class="feed-body">
                    <div class="feed-text"><span class="who">Stormwind</span> earned <span class="badge">Gold Boss Ready</span> with <span class="what">Yutyrannus</span></div>
                    <div class="feed-meta"><span class="source ally">🤝 ally tribe</span></div>
                </div>
                <div class="feed-time">1d</div>
            </div>
        </div>
    </div>

    <!-- ═══════════ TRIBE TAB ═══════════ -->
    <div class="tab-content" class:active={activeTab === 'tribe'}>
        <div class="filter-row">
            <button class="chip active">All Events</button>
            <button class="chip"><span class="glyph">🧬</span>Breeding</button>
            <button class="chip"><span class="glyph">⬢</span>Badges</button>
            <button class="chip"><span class="glyph">⚔</span>Boss Kills</button>
            <button class="chip"><span class="glyph">⇆</span>Trades</button>
        </div>
        <div class="feed">
            <div class="feed-event breeding">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(0,180,255,0.18)" stroke="#00b4ff" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#7dd3fc">S</text></svg><span class="type-glyph">🧬</span></div>
                <div class="feed-body">
                    <div class="feed-text"><span class="who">Specter</span> bred <span class="what">Wyvern "Storm Jr"</span> · STA +1</div>
                    <div class="feed-meta"><span class="source tribe">⌬ Bloodline Tribe</span></div>
                </div>
                <div class="feed-time">12m</div>
            </div>
            <div class="feed-event diamond">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(255,215,0,0.18)" stroke="#ffd700" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#fde047">C</text></svg><span class="type-glyph">⬢</span></div>
                <div class="feed-body">
                    <div class="feed-text"><span class="who you alpha">You</span> earned <strong>Diamond Prize Bloodline</strong></div>
                    <div class="feed-meta">Top 1% server-wide</div>
                </div>
                <div class="feed-time">1h</div>
            </div>
            <div class="feed-event tribe">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(0,180,255,0.18)" stroke="#00b4ff" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#7dd3fc">B</text></svg><span class="type-glyph">⌬</span></div>
                <div class="feed-body">
                    <div class="feed-text"><span class="tribe">Bloodline Tribe</span> scheduled <strong>Alpha Manticore</strong> war room · Sat 5/18</div>
                    <div class="feed-meta">5/8 committed</div>
                </div>
                <div class="feed-time">8h</div>
            </div>
        </div>
    </div>
    ...
    <div class="tab-content" class:active={activeTab === 'server'}>
        ...
        <div class="section-head">
            ...
            <button class="action">Manage <span class="arrow">▸</span></button>
        </div>

        <div class="cluster-card">
            <div class="cluster-head">
                <div class="cluster-info">
                    <div class="cluster-name">Loaded Crysis Cluster</div>
                    <div class="cluster-stats">
                        <span class="live-pip"></span>
                        <span class="stat">4 servers</span><span class="sep">·</span>
                        <span class="stat">74/135 online</span><span class="sep">·</span>
                        cluster uptime <span class="stat">47d</span>
                    </div>
                </div>
                <div class="cluster-actions">
                    <button class="cluster-btn">+ Add Server</button>
                    <button class="cluster-btn danger">Remove</button>
                </div>
            </div>
            <div class="server-grid">
                ...
                <div class="server-card">
                    <div class="server-card-top">
                        <span class="server-card-name">Ragnarok·07</span>
                        <span class="server-card-status online"><span class="pip"></span>Online</span>
                    </div>
                    <div class="server-card-meta">
                        <div><div class="lbl">Players</div><div class="val players">28 / 35</div></div>
                        <div><div class="lbl">Uptime</div><div class="val">14d 22h</div></div>
                    </div>
                </div>

                <div class="server-card">
                    <div class="server-card-top">
                        <span class="server-card-name">The Island·12</span>
                        <span class="server-card-status online"><span class="pip"></span>Online</span>
                    </div>
                    <div class="server-card-meta">
                        <div><div class="lbl">Players</div><div class="val players">18 / 35</div></div>
                        <div><div class="lbl">Uptime</div><div class="val">7d 4h</div></div>
                    </div>
                </div>

                <div class="server-card">
                    <div class="server-card-top">
                        <span class="server-card-name">Aberration·03</span>
                        <span class="server-card-status online"><span class="pip"></span>Online</span>
                    </div>
                    <div class="server-card-meta">
                        <div><div class="lbl">Players</div><div class="val players">6 / 25</div></div>
                        <div><div class="lbl">Uptime</div><div class="val">2d 11h</div></div>
                    </div>
                </div>

                <div class="server-card offline">
                    <div class="server-card-top">
                        <span class="server-card-name">Extinction·05</span>
                        <span class="server-card-status offline"><span class="pip"></span>Restarting</span>
                    </div>
                    <div class="server-card-meta">
                        <div><div class="lbl">Players</div><div class="val">— / 40</div></div>
                        <div><div class="lbl">Back in</div><div class="val">2m 14s</div></div>
                    </div>
                </div>
        ...
        <div class="feed">
            ...
            <div class="feed-event boss">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(245,158,11,0.18)" stroke="#f59e0b" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#fcd34d">M</text></svg><span class="type-glyph">⚔</span></div>
                <div class="feed-body">
                    <div class="feed-text"><strong>Alpha Manticore</strong> spawned at the boss arena · respawn cycle complete</div>
                    <div class="feed-meta"><span class="source map">⌬ RAGNAROK·07</span><span class="sep">·</span>3 tribes claiming</div>
                </div>
                <div class="feed-time">2m</div>
            </div>

            <div class="feed-event admin">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(239,68,68,0.15)" stroke="#ef4444" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="38" font-weight="900" text-anchor="middle" fill="#fca5a5">AD</text></svg><span class="type-glyph">!</span></div>
                <div class="feed-body">
                    <div class="feed-text"><strong>Admin announcement</strong> — Server restart scheduled in 2 hours for patch v8.34. Save progress.</div>
                    <div class="feed-meta"><span class="source map">⌬ THE ISLAND·12</span><span class="sep">·</span>posted by ServerAdmin</div>
                </div>
                <div class="feed-time">8m</div>
            </div>

            <div class="feed-event server">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(6,182,212,0.18)" stroke="#06b6d4" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#67e8f9">V</text></svg><span class="type-glyph">⬡</span></div>
                <div class="feed-body">
                    <div class="feed-text">New survivor <span class="who">Vortex</span> joined the server</div>
                    <div class="feed-meta"><span class="source map">⌬ RAGNAROK·07</span><span class="sep">·</span>Survivor #1247</div>
                </div>
                <div class="feed-time">1h</div>
            </div>
            ...
            <div class="feed-event boss">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(0,180,255,0.18)" stroke="#00b4ff" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="44" font-weight="900" text-anchor="middle" fill="#7dd3fc">B</text></svg><span class="type-glyph">⚔</span></div>
                <div class="feed-body">
                    <div class="feed-text"><span class="tribe">Bloodline Tribe</span> beat <span class="boss">Beta Manticore</span> · 6 survivors, 0 losses · 3:42 clear</div>
                    <div class="feed-meta"><span class="source map">⌬ RAGNAROK·07</span></div>
                </div>
                <div class="feed-time">2h</div>
            </div>

            <div class="feed-event server">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(6,182,212,0.18)" stroke="#06b6d4" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="38" font-weight="900" text-anchor="middle" fill="#67e8f9">SY</text></svg><span class="type-glyph">⬡</span></div>
                <div class="feed-body">
                    <div class="feed-text">Cluster-wide backup complete · all 4 servers · 12.4 GB saved</div>
                    <div class="feed-meta"><span class="source">System</span><span class="sep">·</span>next backup 6h</div>
                </div>
            ...
            <div class="feed-event admin">
                <div class="feed-avatar"><svg viewBox="0 0 100 110"><polygon points="50,2 96,28 96,82 50,108 4,82 4,28" fill="rgba(239,68,68,0.15)" stroke="#ef4444" stroke-width="2"/><text x="50" y="74" font-family="Orbitron" font-size="38" font-weight="900" text-anchor="middle" fill="#fca5a5">AD</text></svg><span class="type-glyph">!</span></div>
                <div class="feed-body">
                    <div class="feed-text"><strong>Admin announcement</strong> — 2x breeding rates active this weekend · ends Sun 23:59 UTC</div>
                    <div class="feed-meta"><span class="source">Cluster-wide</span></div>
                </div>
                <div class="feed-time">1d</div>
            </div>
    ...
    <div class="tab-content" class:active={activeTab === 'global'}>
        ...
        <div class="source-row">
            ...
            <button class="source-chip add">+ Add Source</button>
        </div>
        ...
        <div class="section-head" style="margin-top:24px">
            ...
            Latest News
            <span class="rule"></span>
            <span class="count">42 today</span>
        </div>

        <div class="news-feed">

            <div class="news-item twitter">
                <div class="news-platform">𝕏</div>
                <div class="news-body">
                    <div class="news-header">
                        <span class="platform-name">Twitter / X</span>
                        <span class="sep">·</span>
                        <span class="author">@survivetheark</span>
                        <span class="time">12m</span>
                    </div>
                    <div class="news-excerpt">New <strong>Wyvern variants</strong> coming in the 2026 patch — full breakdown thread. Lightning Wyverns getting a Tek armor compatibility update. <span class="hashtag">#ARKAscended</span> <span class="hashtag">#TekUpdate</span></div>
                    <div class="news-engage">
                        <span class="stat">♡ <span class="num">2.4k</span></span>
                        <span class="stat">↻ <span class="num">847</span></span>
                        <span class="stat">↩ <span class="num">312</span></span>
            ...
            <div class="news-item youtube">
                <div class="news-platform">▶</div>
                <div class="news-body">
                    <div class="news-header">
                        <span class="platform-name">YouTube</span>
                        <span class="sep">·</span>
                        <span class="author">Loaded Crysis</span>
                        <span class="time">1h</span>
                    </div>
                    <div class="news-title">Cluster Boss Hunt: Manticore Strategy w/ Bloodline Tribe</div>
                    ...
                    <div class="news-engage">
                        <span class="stat">▶ <span class="num">142k</span> views</span>
                        <span class="stat">♡ <span class="num">8.2k</span></span>
                        <button class="open-btn">Watch ▸</button>
                    </div>
                </div>
            </div>

            <div class="news-item sta">
                <div class="news-platform">⌬</div>
                <div class="news-body">
                    <div class="news-header">
                        <span class="platform-name">Survive The Ark</span>
                        <span class="sep">·</span>
                        <span class="author">News</span>
                        <span class="time">3h</span>
                    </div>
                    <div class="news-title">Studio Wildcard reveals roadmap for Q3 2026: New map confirmed</div>
                    <div class="news-excerpt">Wildcard officially announced the next ASA map drop along with a rebalance of late-game bosses. The leak from Reddit last week was largely accurate — including the Genesis 1 port for 2027...</div>
                    <div class="news-engage">
                        <span class="stat">⏱ <span class="num">4 min read</span></span>
                        <span class="stat">💬 <span class="num">214</span></span>
                        <button class="open-btn">Read ▸</button>
                    </div>
                </div>
            </div>
            ...
            <div class="news-item twitter">
                ...
                <div class="news-body">
                    <div class="news-header">
                        <span class="platform-name">Twitter / X</span>
                        <span class="sep">·</span>
                        <span class="author">@studiowildcard</span>
                        <span class="time">5h</span>
                    </div>
                    <div class="news-excerpt"><strong>Scorched Earth</strong> boss rebalance coming next patch — server admins, prepare for new boss damage curves. Tested on PTS this week. Patch notes drop friday.</div>
                    <div class="news-engage">
                        <span class="stat">♡ <span class="num">6.1k</span></span>
                        <span class="stat">↻ <span class="num">1.8k</span></span>
                        <button class="open-btn">Open ▸</button>
                    </div>
                </div>
            </div>
            ...
            <div class="news-item youtube">
                ...
                <div class="news-body">
                    ...
                    <div class="news-title">Bloodline Tribe Featured: Wyvern Breeding Guide 2026</div>
                    <div class="video-thumb">
                        <div class="video-thumb-play">
                            <svg viewBox="0 0 24 24" fill="currentColor"><polygon points="5,3 19,12 5,21"/></svg>
                        </div>
                    ...
                    <div class="news-engage">
                        <span class="stat">▶ <span class="num">68k</span> views</span>
                        <span class="stat">♡ <span class="num">4.4k</span></span>
                        <button class="open-btn">Watch ▸</button>
                    </div>
                </div>
            </div>
            ...
            <div class="news-item reddit">
                ...
                <div class="news-body">
                    <div class="news-header">
                        ...
                        <span class="sep">·</span>
                        <span class="author">r/ARK</span>
                        <span class="time">1d</span>
                    </div>
                    <div class="news-title">ASA roadmap leaked? Genesis 1 confirmed for 2027 release</div>
                    <div class="news-excerpt">Datamined files from the latest PTS build suggest Genesis 1 is coming sooner than expected. Master Controller boss assets already present in the game files...</div>
                    <div class="news-engage">
                        <span class="stat">⬆ <span class="num">4.7k</span></span>
                        <span class="stat">💬 <span class="num">623</span> comments</span>
                        <button class="open-btn">Open ▸</button>
                    </div>
                </div>
            </div>

            <div class="news-item wildcard">
                <div class="news-platform">⬢</div>
                <div class="news-body">
                    <div class="news-header">
                        <span class="platform-name">Wildcard Blog</span>
                        <span class="sep">·</span>
                        <span class="author">Official</span>
                        <span class="time">2d</span>
                    </div>
                    <div class="news-title">Community Crunch #421 — Bug fixes, Tek tier balance pass, and a sneak peek at Astraeos</div>
                    <div class="news-excerpt">This week's Community Crunch covers the upcoming Tek armor durability fix, balance changes to Wyvern milk drain rates, and our first official look at Astraeos endgame zones...</div>
                    <div class="news-engage">
                        <span class="stat">⏱ <span class="num">6 min read</span></span>
                        <span class="stat">💬 <span class="num">142</span></span>
                        <button class="open-btn">Read ▸</button>
                    </div>
                </div>
            </div>
