...
<div class="std-page">
	<div class="form-page-header">
		...
		<div class="page-title">
			<h1>Edit Specimen</h1>
			<div class="page-subtitle">{String(c.species ?? '')} — {String(c.name ?? '')}</div>
		</div>
	</div>
		...
		<div class="form-section">
			...
			<div class="form-row-2">
				<div class="plan-field">
					...
					<input id="f-species" class="form-control" type="text" list="species-list" bind:value={fSpecies} />
				...
				<div class="plan-field">
					...
					<input id="f-name" class="form-control" type="text" bind:value={fName} />
				</div>
				<div class="plan-field">
